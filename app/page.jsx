  ...
  return (
    <main>
      <div className="bg-black">
        <div className="container relative mx-auto px-[1rem] bg-hero-mobile md:bg-hero-tablet lg:bg-hero-desktop bg-contain bg-center lg:bg-right bg-no-repeat h-[70vh] text-dark-gray">
          <Nav />
