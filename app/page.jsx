...
const Home = () => {
  return (
    <main className="bg-black">
      <div className="container relative mx-auto px-[1rem] bg-hero-mobile md:bg-hero-tablet lg:bg-hero-desktop bg-contain bg-center lg:bg-right bg-no-repeat h-[50vh] text-gray">
        <Nav />
